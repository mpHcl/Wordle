        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HardMode = table.Column<bool>(type: "INTEGER", nullable: false),
                    HighContrastMode = table.Column<bool>(type: "INTEGER", nullable: false),
                    ShowHints = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WordleSettings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_WordleSettings_SettingsId",
                        column: x => x.SettingsId,
                        principalTable: "WordleSettings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageGuesses = table.Column<double>(type: "REAL", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttemptedWord = table.Column<string>(type: "TEXT", nullable: false),
